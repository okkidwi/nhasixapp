        ...
        listener: (context, state) {
          if (state is CrotpediaAuthSuccess) {
            ...
            switch (state.message) {
              case 'key_loginFailed':
                errorMsg = l10n.loginFailed;
                break;
              case 'key_unexpectedLoginError':
                errorMsg = l10n.unexpectedLoginError;
                break;
              case 'key_failedToCaptureSession':
                errorMsg = l10n.failedToCaptureSession;
                break;
              default:
